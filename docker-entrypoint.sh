...
echo -e "Calling DJANGO_SETTINGS_MODULE=config.environments.ebs python server/manage.py makemigrations ..."
DJANGO_SETTINGS_MODULE=config.environments.ebs python server/manage.py makemigrations

echo -e "Calling DJANGO_SETTINGS_MODULE=config.environments.ebs python server/manage.py migrate ..."
...
echo -e "Calling DJANGO_SETTINGS_MODULE=config.environments.ebs python server/manage.py runserver 0:80 ..."
